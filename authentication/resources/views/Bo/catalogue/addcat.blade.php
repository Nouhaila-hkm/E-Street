                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <form action="{{ route('catalogue.add') }}" method="POST" class="register-form" id="register-form">
                            @csrf    
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Id Magasin</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <select class="form-control  p-0 border-0" name="magasinId" >
