            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Modification promo </h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <form action="{{ route('promotion.updated' }}" method="POST" class="register-form" id="register-form">
                            @csrf    
                            <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Id produit</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="catalogueId" value="{{ $promotion->produitId }}"
